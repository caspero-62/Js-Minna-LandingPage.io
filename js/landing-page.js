...
const hamburger_close =  document.querySelector('.close');
...
links_hover.addEventListener('click', () => {
    links_ul.style.display = links_ul.style.display == 'none' ? 'flex' : 'none';
})

hamburger_menu.addEventListener('click', () => {
    toggleDisplay(hamburger_menu);
    toggleDisplay(hamburger_close);
...
hamburger_close.addEventListener('click', () => {
    toggleDisplay(hamburger_menu);
    toggleDisplay(hamburger_close);
    // links_ul.classList.add('fadeOut');
    // links_ul.classList.remove('fadeIn');
    links_ul.style.display = links_ul.style.display == 'none' ? 'flex' : 'none';
})
